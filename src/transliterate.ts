// Harflar xaritasi (Lug'atlar)
const latinToCyrillicMap: Record<string, string> = {
  // Basic letters
  A: "А", a: "а", B: "Б", b: "б", D: "Д", d: "д", E: "Е", e: "е",
  F: "Ф", f: "ф", G: "Г", g: "г", H: "Ҳ", h: "ҳ", X: "Х", x: "х",
  J: "Ж", j: "ж", K: "К", k: "к", Q: "Қ", q: "қ", L: "Л", l: "л",
  M: "М", m: "м", N: "Н", n: "н", O: "О", o: "о", P: "П", p: "п",
  R: "Р", r: "р", S: "С", s: "с", T: "Т", t: "т", U: "У", u: "у",
  V: "В", v: "в", Z: "З", z: "з",
  // Special letters
  Á: "Ә", á: "ә", Ó: "Ө", ó: "ө", Ú: "Ү", ú: "ү", I: "И", i: "и",
  Í: "Ы", ı: "ы", Ǵ: "Ғ", ǵ: "ғ", Ń: "Ң", ń: "ң",
  // Extra letters
  Y: "Й", y: "й", W: "Ў", w: "ў",
  // Digraphs
  Sh: "Ш", sh: "ш", SH: "Ш", Yu: "Ю", yu: "ю", Ya: "Я", ya: "я",
  Yo: "Ё", yo: "ё", Ch: "Ч", ch: "ch", CH: "Ч",
...
const cyrillicToLatinMap: Record<string, string> = {
  ...
  Ё: "Yo", ё: "yo", Ж: "J", ж: "j", З: "Z", з: "z", И: "I", и: "i",
  Й: "Y", й: "y", К: "K", к: "k", Қ: "Q", қ: "q", Л: "L", л: "l",
  М: "M", м: "m", Н: "N", н: "n", Ң: "Ń", ң: "ń", О: "O", о: "o",
  Ө: "Ó", ө: "ó", П: "P", п: "p", Р: "R", р: "r", С: "S", с: "s",
  Т: "T", т: "t", У: "U", у: "u", Ү: "Ú", ү: "ú", Ў: "W", ў: "w",
  Ф: "F", ф: "f", Х: "X", х: "x", Ҳ: "H", ҳ: "h", Ш: "Sh", ш: "sh",
  Ч: "Ch", ч: "ch", Щ: "Sh", щ: "sh", Ы: "Í", ы: "ı",
  Ц: "C", ц: "c", Э: "E", э: "e", Ю: "Yu", ю: "yu", Я: "Ya", я: "ya",
  Ъ: "", ъ: "", Ь: "", ь: "",
};
